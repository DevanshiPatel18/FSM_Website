    ...
    return (
        <Grid className={classes.root} style={{display: 'flex', justifyContent: 'space-between'}}>
            ...
            {WorkStationData.map((workstation) => (
                <Card className={classes.card} style={{ width: 32 + '%',boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px' }}>
                    <CardHeader style={{ paddingRight: 0 }}
                        title={
                            <div style={{ marginRight: 0 }}>

                                <Grid style={{ disply: 'inline-block', float: 'right', width: 30 + '%', marginTop: '-' + 3 + '%' }}>
                                ...
                                <h5 className={classes.root} style={{fontWeight: 575}}>{workstation.title}</h5>
                                <hr />
                            </div>
                        }
                    />
